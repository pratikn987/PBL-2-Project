...
<body>
    ...
    <section class="dashboard">
        ...
        <% Connection con=null;
   		 ...
   		 %> 
                <tr>
                  <td><img src="<%out.println(rs.getString("mImgURL")); %>"  height="160px" alt=""></td>
                  <td><%out.println(rs.getString("mName")); %></td>
                  <td><%out.println(rs.getString("mDate")); %></td>
                  <td><%out.println(rs.getString("mMovieTime")); %></td>
                  <td><a href='editmovie.jsp?u=<%=rs.getString("mName")%>'><i class="uil uil-edit"></i></a></td>
                </tr>
        <% }
        	}catch(Exception e) {
    			e.printStackTrace();
